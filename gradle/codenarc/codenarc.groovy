ruleset {
    ...
    //DuplicateMapLiteral  - pages objects riddled with (wait: true) for elements which "violates"
    //DuplicateNumberLiteral

    //files like order generation will contain duplicate litterals so enforcing this seems foolhearty
    ...
    // ClassJavadoc // dcarr dislikes this rule
    ...
    AbcMetric {
        maxClassAverageMethodAbcScore = 60
        maxMethodAbcScore = 60
        ignoreMethodNames = "content"
    ...
    // UnnecessaryReturnKeyword // dcarr dislikes this rule
